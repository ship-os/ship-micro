...
// DEPRECATED: this is frozen package, use github.com/ship-os/ship-micro/v2/logger
package log
...
import (
	...
	dlog "github.com/ship-os/ship-micro/v2/debug/log"
	nlog "github.com/ship-os/ship-micro/v2/logger"
)
