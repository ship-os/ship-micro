// Package kubernetes taken from https://github.com/ship-os/ship-micro/blob/master/debug/log/kubernetes/kubernetes.go
...
import (
	...
	"github.com/ship-os/ship-micro/v2/runtime"
	"github.com/ship-os/ship-micro/v2/util/kubernetes/client"
