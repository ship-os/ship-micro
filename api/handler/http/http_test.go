...
import (
	...
	"github.com/ship-os/ship-micro/v2/api/resolver"
	"github.com/ship-os/ship-micro/v2/api/resolver/vpath"
	"github.com/ship-os/ship-micro/v2/api/router"
	regRouter "github.com/ship-os/ship-micro/v2/api/router/registry"
