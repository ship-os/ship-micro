...
import (
	...
	micro "github.com/ship-os/ship-micro/v2"
	broker "github.com/ship-os/ship-micro/v2/broker"
	server "github.com/ship-os/ship-micro/v2/server"
	rabbitmq "github.com/ship-os/ship-micro/plugins/broker/rabbitmq/v2"
)
