# Plugins [![License](https://img.shields.io/:license-apache-blue.svg)](https://opensource.org/licenses/Apache-2.0) [![GoDoc](https://godoc.org/github.com/ship-os/ship-micro/plugins?status.svg)](https://godoc.org/github.com/ship-os/ship-micro/plugins) [![Go Report Card](https://goreportcard.com/badge/micro/go-plugins)](https://goreportcard.com/report/github.com/ship-os/ship-micro/plugins)
...
import (
	_ "github.com/ship-os/ship-micro/plugins/broker/rabbitmq/v2"
	_ "github.com/ship-os/ship-micro/plugins/registry/kubernetes/v2"
	_ "github.com/ship-os/ship-micro/plugins/transport/nats/v2"
)
```
...
import (
	"github.com/ship-os/ship-micro/v2"
	"github.com/ship-os/ship-micro/plugins/registry/kubernetes/v2"
)
